 ...
 * {@link Company#getCountry()} value and their {@link LevenshteinSimilarity}
 * value.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class CompanyRevenueComparatorRelative extends Comparator<Company> {

	private PercentageSimilarity sim = new PercentageSimilarity(0.5);

	@Override
	public double compare(Company entity1, Company entity2) {
		double similarity = sim.calculate(entity1.getRevenue(), entity2.getRevenue());
