 ...
 * key based on the longest token within the name.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class ReleaseBlockingKeyByLongestTokenInNameGenerator extends BlockingKeyGenerator<Release> {

	@Override
	public String getBlockingKey(Release instance) {
		String[] tokens = instance.getName().split("[^\\w']+");
		return getLongestString(tokens);
	}
