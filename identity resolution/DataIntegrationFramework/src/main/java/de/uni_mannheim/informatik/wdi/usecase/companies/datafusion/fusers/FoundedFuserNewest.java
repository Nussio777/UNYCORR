...
import de.uni_mannheim.informatik.wdi.datafusion.conflictresolution.date.LatestDate;
 ...
 * 
 */
public class FoundedFuserNewest extends AttributeValueFuser<DateTime, Company> {

	public FoundedFuserNewest() {
		super(new LatestDate<Company>());
	}
