 ...
 * key based on the {@link Company#getFounded()}.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class CompanyBlockingKeyByYearGenerator extends BlockingKeyGenerator<Company> {

	@Override
	public String getBlockingKey(Company instance) {
		if (instance.getFounded() != null) {
			return Integer.toString(instance.getFounded().getYear());
		} else {
			return null;
		}
	}
