 ...
 * 
 */
public class ReleaseTrackListComparatorOverlap extends Comparator<Release> {

	private OverlapSimilarity<Track> sim = new OverlapSimilarity<Track>();

	@Override
	public double compare(Release entity1, Release entity2) {
		double similarity = sim.calculate(entity1.getTracks(), entity2.getTracks());
