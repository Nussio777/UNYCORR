...
/**
 * {@link AttributeValueFuser} for the industries of {@link Company}s.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class IndustryFuserVoting extends AttributeValueFuser<String, Company> {

	public IndustryFuserVoting() {
		super(new ShortestString<Company>());
	}
