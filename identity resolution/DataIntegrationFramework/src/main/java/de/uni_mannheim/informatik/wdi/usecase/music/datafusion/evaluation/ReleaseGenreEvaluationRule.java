...
/**
 * {@link EvaluationRule} for the genre of {@link Releases}s. The rule simply
 * compares the genre of two {@link Release}s and returns true, in case their
 * similarity based on {@link TokenizingJaccardSimilarity} is 1.0.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class ReleaseGenreEvaluationRule extends EvaluationRule<Release> {
