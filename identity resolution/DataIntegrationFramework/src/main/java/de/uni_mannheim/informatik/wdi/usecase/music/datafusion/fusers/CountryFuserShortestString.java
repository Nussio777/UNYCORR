...
/**
 * {@link AttributeValueFuser} for the country of {@link Release}s.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class CountryFuserShortestString extends AttributeValueFuser<String, Release> {
	...
	public void fuse(RecordGroup<Release> group, Release fusedRecord) {
		...
		// add provenance info
		fusedRecord.setAttributeProvenance(Release.COUNTRY, fused.getOriginalIds());
	}

	@Override
	public boolean hasValue(Release record) {
		return record.hasValue(Release.COUNTRY);
	}
