...
import de.uni_mannheim.informatik.wdi.datafusion.conflictresolution.date.EarliestDate;
 ...
 * 
 */
public class FoundedFuserOldest extends AttributeValueFuser<DateTime, Company> {

	public FoundedFuserOldest() {
		super(new EarliestDate<Company>());
	}
