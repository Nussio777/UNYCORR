 ...
 * key based on the number of tracks
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class ReleaseBlockingKeyByNumberOfTracks extends BlockingKeyGenerator<Release> {

	@Override
	public String getBlockingKey(Release instance) {
		double ret = 0;
		if (instance.getTracks() != null) {
			ret = instance.getTracks().size();
		}
