 ...
 * 
 */
public class FoundedFuserFavourSource extends AttributeValueFuser<DateTime, Company> {

	public FoundedFuserFavourSource() {
		super(new FavourSources<DateTime, Company>());
	}
