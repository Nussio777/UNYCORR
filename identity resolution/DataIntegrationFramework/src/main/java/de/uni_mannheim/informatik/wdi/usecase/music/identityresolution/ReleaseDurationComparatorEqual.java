 ...
 * {@link Release#getDuration()} value and their {@link EqualsSimilarity} value.
 * 
 * @author Robert Meusel (robert@dwslab.de)
 * 
 */
public class ReleaseDurationComparatorEqual extends Comparator<Release> {

	private EqualsSimilarity<Integer> sim = new EqualsSimilarity<Integer>();

	@Override
	public double compare(Release entity1, Release entity2) {
		double similarity = sim.calculate(entity1.getDuration(), entity2.getDuration());
